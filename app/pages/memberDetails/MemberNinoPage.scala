...
case object MemberNinoPage extends QuestionPage[String] {
  ...
  override def cleanup(value: Option[String], userAnswers: UserAnswers): Try[UserAnswers] =
    userAnswers.syncToFormData(value)(this)(name => _.updateMemberDetailsOrCreate(_.copy(memberNino = Some(name))))(userAnswers)

  override def read(userAnswers: UserAnswers): Option[String] =
    userAnswers.get(_.memberDetails.flatMap(_.memberNino))
  ...
  final def changeLink(answers: UserAnswers): Call =
    routes.MemberNinoController.onPageLoad(CheckMode)
}
