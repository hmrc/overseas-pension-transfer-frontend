...
object ViewUtils {
  ...
  def titleWithPagination(title: String, pagePrefix: String)(implicit messages: Messages): String = {
    val govUk = messages("site.govuk")
    s"$pagePrefix – ${messages(title)} – $govUk"
  }
