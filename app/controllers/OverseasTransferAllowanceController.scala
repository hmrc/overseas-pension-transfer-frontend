...
import forms.OverseasTransferAllowanceFormProvider
import models.Mode
...
import views.html.OverseasTransferAllowanceView
    ...
    implicit request =>
      form.bindFromRequest().fold(
        ...
        value =>
          ...
          } yield Redirect(OverseasTransferAllowancePage.nextPage(mode, updatedAnswers))
      )
  }
}
