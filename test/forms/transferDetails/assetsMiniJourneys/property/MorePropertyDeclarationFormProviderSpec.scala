...
class MorePropertyDeclarationFormProviderSpec extends BooleanFieldBehaviours {

  val requiredKey = "morePropertyDeclaration.error.required"
  val invalidKey  = "error.boolean"

  val form = new MorePropertyDeclarationFormProvider()()
