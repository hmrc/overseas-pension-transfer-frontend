...
class AdditionalQuotedSharesFormProviderSpec extends BooleanFieldBehaviours {

  val requiredKey = "additionalQuotedShares.error.required"

  val form = new AdditionalQuotedSharesFormProvider()()
