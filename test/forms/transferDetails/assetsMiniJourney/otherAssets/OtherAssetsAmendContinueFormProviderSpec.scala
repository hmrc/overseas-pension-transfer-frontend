...
class OtherAssetsAmendContinueFormProviderSpec extends BooleanFieldBehaviours {

  val requiredKey = "otherAssetsAmendContinue.error.required"

  val form = new OtherAssetsAmendContinueFormProvider()()
