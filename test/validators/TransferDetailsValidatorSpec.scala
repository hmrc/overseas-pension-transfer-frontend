...
class TransferDetailsValidatorSpec extends AnyFreeSpec with SpecBase {
  ...
  private def buildBaseUserAnswers = emptyUserAnswers
    .set(OverseasTransferAllowancePage, BigDecimal(1000.25))
    .success
    .value
    .set(AmountOfTransferPage, BigDecimal(2000.88))
    .success
    .value
    .set(IsTransferTaxablePage, true)
    .success
    .value
    .set(WhyTransferIsTaxablePage, WhyTransferIsTaxable.TransferExceedsOTCAllowance)
    .success
    .value
    .set(ApplicableTaxExclusionsPage, Set[ApplicableTaxExclusions](ApplicableTaxExclusions.Occupational))
    .success
    .value
    .set(AmountOfTaxDeductedPage, BigDecimal(100.33))
    .success
    .value
    .set(NetTransferAmountPage, BigDecimal(1900.99))
    .success
    .value
    .set(DateOfTransferPage, today)
    .success
    .value
    .set(IsTransferCashOnlyPage, true)
    .success
    .value
    .set(TypeOfAssetPage, Seq(Cash))
    .success
    .value
    ...
    "must return valid TransferDetails" - {
      "when all required fields are provided" in {
        val userAnswers = buildBaseUserAnswers
          .set(CashAmountInTransferPage, BigDecimal(2000.88))
          .success
          .value

        validator.fromUserAnswers(userAnswers) mustBe
          Valid(
            baseTransferDetails.copy(
      ...
      "When transfer is taxable and WhyTransferIsTaxable is NoExclusion with ApplicableExclusion None" in {
        val validWithNoExclusion = Json.obj(
      ...
      "when a transfer includes a cash asset" - {
        "when value is not cash only with a valid amount" in {
          val userAnswers = buildBaseUserAnswers
            ...
            .success
            .value
            .set(TypeOfAssetPage, Seq(TypeOfAsset.Cash))
            .success
            .value
            .set(CashAmountInTransferPage, testCashAmount)
            .success
            .value
      ...
      "when a transfer includes unquoted shares" - {
        "with valid share details" in {
          val userAnswers = buildBaseUserAnswers
            ...
            .success
            .value
            .set(TypeOfAssetPage, Seq(TypeOfAsset.UnquotedShares))
            .success
            .value
            .set(UnquotedSharesCompanyNamePage(0), testCompanyName1)
            .success
            .value
            .set(UnquotedSharesValuePage(0), testUnquotedShareValue)
            .success
            .value
            .set(UnquotedSharesNumberPage(0), testUnquotedShareCount)
            .success
            .value
            .set(UnquotedSharesClassPage(0), testShareClass1)
            .success
            .value
      ...
      "when a transfer includes property assets" - {
        "with valid property details" in {
          val userAnswers = buildBaseUserAnswers
            ...
            .success
            .value
            .set(TypeOfAssetPage, Seq(TypeOfAsset.Property))
            .success
            .value
            .set(PropertyAddressPage(0), testPropertyAddress)
            .success
            .value
            .set(PropertyValuePage(0), BigDecimal(1000000.99))
            .success
            .value
            .set(PropertyDescriptionPage(0), "Bungalow")
            .success
            .value
      ...
      "when a transfer includes quoted shares" - {
        "with valid share details" in {
          val userAnswers = buildBaseUserAnswers
            ...
            .success
            .value
            .set(TypeOfAssetPage, Seq(TypeOfAsset.QuotedShares))
            .success
            .value
            .set(QuotedSharesCompanyNamePage(0), testCompanyName2)
            .success
            .value
            .set(QuotedSharesValuePage(0), testQuotedShareValue)
            .success
            .value
            .set(QuotedSharesNumberPage(0), testQuotedShareCount)
            .success
            .value
            .set(QuotedSharesClassPage(0), testShareClass2)
            .success
            .value
      ...
      "when a transfer includes other assets" - {
        "with valid asset details" in {
          val userAnswers = buildBaseUserAnswers
            ...
            .success
            .value
            .set(TypeOfAssetPage, Seq(TypeOfAsset.Other))
            .success
            .value
            .set(OtherAssetsDescriptionPage(0), testAssetDesc1)
            .success
            .value
            .set(OtherAssetsValuePage(0), testAssetValue1)
            .success
            .value
            .set(OtherAssetsDescriptionPage(1), testAssetDesc2)
            .success
            .value
            .set(OtherAssetsValuePage(1), testAssetValue2)
            .success
            .value
      ...
      "when a transfer has 5 added assets and more then 5 value" in {
        ...
        val userAnswers = buildBaseUserAnswers
          ...
          .success
          .value
          .set(OtherAssetsQuery, otherAssetList)
          .success
          .value
          .set(MoreOtherAssetsDeclarationPage, true)
          .success
          .value
    ...
    "must return errors" - {
      ...
      "when a cash asset is selected but the amount is missing" in {
        val userAnswers = buildBaseUserAnswers
          ...
          .success
          .value
          .remove(CashAmountInTransferPage)
          .success
          .value
      ...
      "when paymentTaxableOverseas == true and WhyTransferNotTaxable is present" in {
        ...
        validator.fromUserAnswers(userAnswers) mustBe Invalid(
          Chain(
