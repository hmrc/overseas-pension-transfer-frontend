...
class ApplicableTaxExclusionsPageSpec extends AnyFreeSpec with Matchers with SpecBase {
  ...
  ".nextPage" - {
    ...
    "in FinalCheckMode" - {
      "must go to Final Check Answers page" in {
        ApplicableTaxExclusionsPage.nextPage(FinalCheckMode, emptyAnswers) mustEqual
