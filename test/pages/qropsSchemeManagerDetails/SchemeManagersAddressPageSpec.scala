...
class SchemeManagersAddressPageSpec extends AnyFreeSpec with Matchers with SpecBase {
  ...
  ".nextPage" - {
    ...
    "in Normal Mode" - {
      ...
      "must go to Index" in {
        ...
        SchemeManagersAddressPage.nextPage(NormalMode, emptyUserAnswers) mustEqual routes.SchemeManagersEmailController
    ...
    "in Check Mode" - {
      ...
      "must go to Check Answers" in {
        ...
        SchemeManagersAddressPage.nextPage(
          CheckMode,
          emptyUserAnswers
