  ...
  ".nextPage" - {
    ...
    "in Check Mode" - {
      ...
      "must go to Check Answers" in {
        ...
        MembersLastUKAddressPage.nextPage(CheckMode, emptyAnswers) mustEqual routes.MemberDetailsCYAController.onPageLoad()
      }
    }

    "in FinalCheckMode" - {
      "must go to Final Check Answers page" in {
        MembersLastUKAddressPage.nextPage(FinalCheckMode, emptyAnswers) mustEqual
    ...
    "in AmendCheckMode" - {
      "must go to Amend Check Answers page" in {
        MembersLastUKAddressPage.nextPage(AmendCheckMode, emptyAnswers) mustEqual
