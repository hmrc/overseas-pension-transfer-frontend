...
import views.html.transferDetails.AddPropertyView

class AddPropertyControllerSpec extends AnyFreeSpec with SpecBase with MockitoSugar {

  private lazy val addPropertyRoute = routes.AddPropertyController.onPageLoad().url
