...
import forms.transferDetails.assetsMiniJourney.unquotedShares.NumberOfUnquotedSharesFormProvider
...
import views.html.transferDetails.assetsMiniJourney.unquotedShares.NumberOfUnquotedSharesView
...
class NumberOfUnquotedSharesControllerSpec extends AnyFreeSpec with SpecBase with MockitoSugar {
  ...
  lazy val numberOfUnquotedSharesRoute = AssetsMiniJourneysRoutes.NumberOfUnquotedSharesController.onPageLoad(NormalMode, index).url
