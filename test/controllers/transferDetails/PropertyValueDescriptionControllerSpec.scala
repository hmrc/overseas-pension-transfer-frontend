...
import forms.transferDetails.PropertyValueDescriptionFormProvider
...
import views.html.transferDetails.PropertyValueDescriptionView
...
class PropertyValueDescriptionControllerSpec extends AnyFreeSpec with SpecBase with MockitoSugar {
  ...
  private lazy val propertyValueDescriptionRoute = routes.PropertyValueDescriptionController.onPageLoad(NormalMode).url
