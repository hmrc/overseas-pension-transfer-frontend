  ...
  "TransferDetailsSummary" - {
    "must return all rows when all data is available" in {
      val userAnswers = emptyUserAnswers
        .set(OverseasTransferAllowancePage, BigDecimal(1000))
        .success
        .value
        .set(AmountOfTransferPage, BigDecimal(10000))
        .success
        .value
        ...
        .success
        .value
        .set(NetTransferAmountPage, BigDecimal(9000))
        .success
        .value
        ...
        .success
        .value
        .set(CashAmountInTransferPage, BigDecimal(5000))
        .success
        .value
        .set(PropertyQuery, List.fill(5)(propertyEntry))
        .success
        .value
        .set(MorePropertyDeclarationPage, true)
        .success
        .value
        .set(UnquotedSharesQuery, List.fill(5)(unquotedShareEntry))
        .success
        .value
        .set(MoreUnquotedSharesDeclarationPage, true)
        .success
        .value
        .set(QuotedSharesQuery, List.fill(5)(quotedShareEntry))
        .success
        .value
        .set(MoreQuotedSharesDeclarationPage, true)
        .success
        .value
        .set(OtherAssetsQuery, List.fill(5)(otherAssetEntry))
        .success
        .value
    ...
    "must not include 'more than 5' rows when there are 5 or fewer assets" in {
      val userAnswers = emptyUserAnswers
        ...
        .success
        .value
        .set(PropertyQuery, List(propertyEntry))
        .success
        .value
        .set(MorePropertyDeclarationPage, false)
        .success
        .value
        .set(UnquotedSharesQuery, List.fill(2)(unquotedShareEntry))
        .success
        .value
        .set(MoreUnquotedSharesDeclarationPage, false)
        .success
        .value
        .set(QuotedSharesQuery, List.fill(3)(quotedShareEntry))
        .success
        .value
        .set(MoreQuotedSharesDeclarationPage, false)
        .success
        .value
        .set(OtherAssetsQuery, List.fill(4)(otherAssetEntry))
        .success
        .value
        .set(MoreOtherAssetsDeclarationPage, false)
        .success
        .value
    ...
    "must include cash amount row when transfer is not cash only" in {
      val userAnswers = emptyUserAnswers
        ...
        .success
        .value
        .set(CashAmountInTransferPage, BigDecimal(1000))
        .success
        .value
